...
for day_count in range(1,32):
    ...
    try:
        ...
        driver.find_element(By.ID, "dailyWorkButton" + str(dt.year) + "-" + str(dt.month) + "-" + str(day_count).zfill(2)).click()
        sleep(1)
        driver.find_element(By.CSS_SELECTOR, "#empWorkSlider0 > tbody > tr:nth-child(2) > td:nth-child(2) > div").click()
